...
server.get(
    ...
    function (req, res, next) {
        ...
        if (req.currentCustomer.profile) {
            ...
            var productLineItemsModel = new ProductLineItemsModel(currentBasket.productLineItems, 'basket');
            var lineItems = productLineItemsModel.items;
            ...
            res.render('/checkout/checkoutLogin', {
                ...
                lineItems: lineItems,
                giftCertificateLineItems: currentBasket.getGiftCertificateLineItems().toArray()
            });
        }
