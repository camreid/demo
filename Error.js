...
server.use('Start', consentTracking.consent, function (req, res, next) {
    ...
    pageMetaHelper.setPageMetaData(req.pageMetaData, { pageTitle: Resource.msg('global.page.title.errornotfound', 'common', null)});

    var viewData = res.getViewData();
    viewData.canonicalUrl = require('*/cartridge/scripts/util/canonicalLink').getCanonicalLink('Error-Start');
