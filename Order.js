...
server.get(
    ...
    function (req, res, next) {
        ...
        var orderCustomerNo = order.getCustomerNo();
...
server.post(
    ...
    function (req, res, next) {
        ...
        var registrationObj = {
            ...
            addToEmailList: session.custom.marketingListOptIn
        };
                ...
                try {
                    Transaction.wrap(function () {
                        ...
                        if (!authenticatedCustomer) {
                            ...
                            newCustomerProfile.custom.emailSubscription = registrationData.addToEmailList;
